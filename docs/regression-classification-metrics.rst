...
.. admonition:: QUESTION 1
    ...
    .. container:: toggle
        ...
        **ANSWER**:
            ...
            **(B)** The ``.fit()`` method is used by the Estimator interface to train models often by estimating parameters.
            The ``.transform()`` method is used by the Transformer interface.  The ``.fit_transform()`` combines the two.